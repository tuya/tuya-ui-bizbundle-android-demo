package com.thingclips.groupmanager;
...
import com.thingclips.groupmanager.adapter.SimpleDevListAdapter;
import com.thingclips.groupmanager.bean.SimpleDeviceBean;
...
public class GroupListActivity extends AppCompatActivity {
    ...
    private void createGroup(String devId) {
        //  跳入创建群组
        GroupState groupState = ThingGroupManager.getInstance().createGroup(GroupListActivity.this, devId);
    ...
    private void editGroup(long groupId) {
        //  跳入编辑群组
        GroupState groupState = ThingGroupManager.getInstance().editGroup(GroupListActivity.this, groupId);
        if (groupState == GroupState.SUPPORT) {
            // 群组支持编辑
        } else if (groupState == GroupState.NONE) {
